...
export default function RoseDay() {
  const [stage, setStage] = useState(0);
  const [isRevealed, setIsRevealed] = useState(false);
  const [userName, setUserName] = useState("Someone Special"); // ← default value
        ...
        {!isRevealed ? (
          ...
          >
            ...
            <div className="mb-8 md:mb-12 text-center">
              ...
              <p className="text-rose-100/70 text-sm md:text-base italic font-light">
                Hey {userName}, tap karke dekho kya khilta hai 🌹
              </p>
            </div>
          ...
          >
            ...
            >
              <p className="text-rose-100/90 text-base md:text-lg lg:text-xl font-serif italic leading-relaxed px-2 md:px-4">
                "Jaise gulaab ki khushboo hawa mein ghul jaati hai, waise hi tum meri zindagi mein ghul gayi ho, {userName}."
              </p>
